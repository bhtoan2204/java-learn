...
public class BrandRepository implements IBrandRepository {
    ...
    @Override
    public List<Brand> findByStatus(Brand.BrandStatus status) {
        // Implementation logic to find brands by status
        return null; // Replace with actual implementation
    }

    @Override
    public boolean existsByName(String name) {
        // Implementation logic to check if a brand exists by name
    ...
    @Override
    public Brand getReferenceById(String id) {
        // TODO Auto-generated method stub
    ...
    @Override
    public List<Brand> findAllById(Iterable<String> ids) {
        // TODO Auto-generated method stub
